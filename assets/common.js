...
const STRINGS = {
  zh: {
    ...
    nav_fanart: "粉絲創作", nav_timeline: "年表",
    sec_fanart: "粉絲創作", fanart_subtitle: "粉絲為はじめ繪製的賀圖（皆經繪師同意刊載）",
    fanart_view: "繪師的貼文",
    ...
    nav_past: "過去的企劃", past_subtitle: "歷年已結束的應援企劃", empty_past: "目前還沒有過去的企劃。", see_past: "看過去的企劃",
    nav_replies: "番長的回信", sec_replies: "番長的回信", reply_author: "轟はじめ", replies_subtitle: "番長對本企劃的回應", empty_replies: "目前還沒有番長的回信。",
    ...
    post_original: "查看原文",
    staff_illustrators: "繪師", staff_designers: "設計師", staff_members: "成員", staff_mascot: "吉祥物",
  ...
  ja: {
    ...
    nav_past: "過去の企画", past_subtitle: "これまでに終了した応援企画", empty_past: "過去の企画はまだありません。", see_past: "過去の企画を見る",
    nav_replies: "番長の返信", sec_replies: "番長からの返信", reply_author: "轟はじめ", replies_subtitle: "本企画への番長からの反応", empty_replies: "まだ番長からの返信はありません。",
    ...
    post_original: "原文を見る",
    staff_illustrators: "イラストレーター", staff_designers: "デザイナー", staff_members: "メンバー", staff_mascot: "マスコット",
  ...
  en: {
    ...
    nav_past: "Past Projects", past_subtitle: "Support projects that have ended", empty_past: "No past projects yet.", see_past: "See past projects",
    nav_replies: "From Hajime", sec_replies: "A Word from Hajime", reply_author: "Todoroki Hajime", replies_subtitle: "Hajime's responses to our project", empty_replies: "No replies from Hajime yet.",
    ...
    staff_illustrators: "Illustrators", staff_designers: "Designers", staff_members: "Members",staff_mascot: "Mascot",
